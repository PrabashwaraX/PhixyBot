...
from PhixyBot import BOT_USERNAME, OWNER_ID, pbot, arq
from PhixyBot.pyrogramee.pluginshelper import convert_seconds_to_minutes as time_convert
from PhixyBot.pyrogramee.pluginshelper import fetch
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/PhixyBot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Phixy](https://github.com/WKRPrabashwara/PhixyBot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
