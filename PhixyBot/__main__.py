...
DONATE_STRING =f"[💡](https://telegra.ph/file/47c92277402eb44528b56.jpg)*@ImPrabashwara*"
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="👑 Owner", callback_data="owner_"),
                 ],
                 [
...
#--------------------------------------------------------------------------------------------------------------------------    
        ...
        query.message.edit_text(
            text=f"*Credit For Phixy's Devs*\n"
            f"\nHere Some Developers Helping in Making The Phixy Bot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="👨‍💻 Developers", url="t.me/dihanrandila"),
                    InlineKeyboardButton(text="©️ CopyRight", url="t.me/InukaASiTH"),
                 ],
                 [
                    InlineKeyboardButton(text="⇦ Back", callback_data="phixy_basichelp"),
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "I'm Online Now! 🧚💫 | @TeamPhixY")
        except Unauthorized:
            LOGGER.warning(
                """ 
╭━━╮╱╱╱╭╮╱╭━━━╮╭╮╱╱╱╱╱╭╮╱╱╱╱╱╭╮
