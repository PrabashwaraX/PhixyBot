...
print("[Phixy]: Initializing AIOHTTP Session")
aiohttpsession = ClientSession()    
    
#install arq
print("[Phixy]: Initializing ARQ Client")
arq = ARQ(ARQ_API_URL, ARQ_API_KEY, aiohttpsession)             
updater = tg.Updater(TOKEN, workers=WORKERS, use_context=True)
telethn = TelegramClient("sophia", API_ID, API_HASH)
pbot = Client("phixypyro", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from PhixyBot.modules.helper_funcs.handlers import (
